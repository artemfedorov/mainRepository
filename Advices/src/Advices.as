package
{
	...
	import view.ScreensContainer;
	
	[SWF(width="1280",height="800",frameRate="60",backgroundColor="#4a4137")]
	
	public class Advices extends Sprite
	{
		...
		private function loaderInfo_completeHandler(event:Event):void
		{
			...
			this._starling = new Starling(ScreensContainer, this.stage);
